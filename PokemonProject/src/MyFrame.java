...
public class MyFrame extends JFrame implements KeyListener, MouseListener, ActionListener, WindowListener {
    ...
    BufferedImage trainerFrontBuffer = null;
    ...
    BufferedImage bigRivalBuffer = null;
    ...
    JLabel statement;
    JLabel bigRivalLabel;
    JLabel rivalHealthBar;
    JLabel rivalHealth;
    JLabel trainerHealthBar;
    JLabel trainerHealth;
    ...
    public MyFrame() {
        ...
        bigRivalLabel = new JLabel();
        rivalHealthBar = new JLabel();
        rivalHealth = new JLabel();
        trainerHealthBar = new JLabel();
        trainerHealth = new JLabel();
        ...
        try {
            ...
            trainerFrontBuffer = ImageIO.read(new File("trainerFront.png"));
            rivalBuffer = ImageIO.read(new File("rivalSprite.png"));
            bigRivalBuffer = ImageIO.read(new File("rivalSprite.png"));
...
//            poliwagFrontBuffer = ImageIO.read(new File("poliwagFrontSprite-removebg-preview.png"));
        ...
        Image trainerFrontScaled = trainerFrontBuffer.getScaledInstance(400, 400, Image.SCALE_SMOOTH);
        Image rivalScaled = rivalBuffer.getScaledInstance(200, 200, Image.SCALE_SMOOTH);
        Image bigRivalScaled = rivalBuffer.getScaledInstance(400, 400, Image.SCALE_SMOOTH);
        ...
        trainerFrontLabel.setIcon(new ImageIcon(trainerFrontScaled));
        rivalLabel.setIcon(new ImageIcon(rivalScaled));
        bigRivalLabel.setIcon(new ImageIcon(bigRivalScaled));
        ...
        statement.setFont(new Font("DialogInput", Font.PLAIN, 30));
        ...
        this.getContentPane().setBackground(new Color(200, 210, 200));
        this.setLayout(null);
...
//        trainerHealth.setVisible(false);
        ...
        trainerFrontLabel.setBounds(0, 0, 400, 400);
        trainerFrontLabel.setVisible(false);
    ...
    public void actionPerformed(ActionEvent e) {
        if (curScreen == 1) {
            ...
            if (e.getSource() == attackTopButton) {
                playerPokemonList[0].attack(0, CPUPokemon[0]);
                if (CPUPokemon[0].hasFainted && CPUPokemon[1].hasFainted && CPUPokemon[2].hasFainted) {
                    gameOver = true;
                    playerWon = true;
                    curScreen += 3;
                }
                if (CPUPokemon[0].hasFainted) {
                    if (CPUPokemon[1].hasFainted) {
                        CPUPokemon[0].switchPokemon(CPUPokemon, 2);
                    }
                    else {
                        CPUPokemon[0].switchPokemon(CPUPokemon, 1);
                    }
                }
                curScreen += 3;
            }
            else if (e.getSource() == attackMiddleButton) {
                playerPokemonList[0].attack(1, CPUPokemon[0]);
                if (CPUPokemon[0].hasFainted && CPUPokemon[1].hasFainted && CPUPokemon[2].hasFainted) {
                    gameOver = true;
                    playerWon = true;
                    curScreen += 3;
                ...
                playerPokemonList[0].attack(2, CPUPokemon[0]);
                if (CPUPokemon[0].hasFainted && CPUPokemon[1].hasFainted && CPUPokemon[2].hasFainted) {
                    gameOver = true;
                    playerWon = true;
                    curScreen += 3;
                ...
                while (true) {
                    ...
                    if (curScreen == 11) {
                        ...
                        if (playerWon) {
                            ...
                            pokemon3.setVisible(true);
                            statement.setVisible(true);
                            trainerFrontLabel.setLocation(350, 175);
                            trainerFrontLabel.setVisible(true);
                            return;
                        }
                        else {
                            statement.setLocation(400, 600);
                            statement.setText(rivalName.toUpperCase() + " BEAT YOU!");
                            pokemon1.setLocation(300, 350);
                            pokemon2.setLocation(900, 350);
                            pokemon3.setLocation(700, 350);
                            pokemon1.setIcon(getIcon(CPUPokemon[0].name, "front"));
                            pokemon1.setVisible(true);
                            pokemon2.setIcon(getIcon(CPUPokemon[1].name, "front"));
                            pokemon2.setVisible(true);
                            pokemon3.setIcon(getIcon(CPUPokemon[2].name, "front"));
                            pokemon3.setVisible(true);
                            statement.setVisible(true);
                            bigRivalLabel.setBounds(350, 175, 400, 400);
